...
/**
 * Ported from the Angular `App` component template (src/app/app.html). The
 * `title` signal becomes a plain constant (it was never mutated). The Angular
 * `@for` control-flow block over the pill data becomes `Array.map`, and
 * `<router-outlet />` becomes React Router's `<Outlet />`.
 */
export const Shell = () => {
      ...
      <main className="main">
        <div className="content">
          <div className="left-side">
            ...
            >
              <g clipPath="url(#a)">
                <path fill="url(#b)" d={ANGULAR_LOGO_PATH} />
                <path fill="url(#c)" d={ANGULAR_LOGO_PATH} />
              </g>
              <defs>
                <radialGradient
                  id="c"
                ...
                >
                  ...
                  <stop offset=".707" stopColor="#FF41F8" stopOpacity=".5" />
